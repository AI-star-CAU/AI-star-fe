...
const EmailSignupForm: React.FC<EmailSignupFormProps> = ({ onSuccess }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        <label htmlFor="signup-email" className="nm-label">이메일</label>
        <input
          id="signup-email"
          type="email"
          autoComplete="email"
      ...
      <div>
        <label htmlFor="signup-name" className="nm-label">이름</label>
        <input
          id="signup-name"
          type="text"
          autoComplete="name"
      ...
      <div>
        <label htmlFor="signup-password" className="nm-label">비밀번호</label>
